...
class CustomRefreshMarkIndicator extends StatefulWidget {
  final Widget child;
  final CheckMarkStyle style;
  final Future<void> onRefresh;
  const CustomRefreshMarkIndicator({
    super.key,
    required this.child,
  ...
  @override
  State<CustomRefreshMarkIndicator> createState() =>
      _CustomRefreshMarkIndicatorState();
}

class _CustomRefreshMarkIndicatorState extends State<CustomRefreshMarkIndicator>
